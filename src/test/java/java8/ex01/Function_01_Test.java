...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = i -> { return new Person("first_"+i, "last_"+i, i, "pass_"+i);};
    // end::intToPerson[]
    ...
    private Function<Person, Account> personToAccount = p -> {
    	Account a = new Account(); a.setBalance(1000); a.setOwner(p); return a;
    };
    // end::personToAccount[]
